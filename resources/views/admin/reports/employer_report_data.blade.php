@if(isset($employerFilterData) && $employerFilterData && count($employerFilterData) && isset($employerFilterData['pv_company_data']) && count($employerFilterData['pv_company_data']))
    @php
        ...
        $emptyPVRows = isset($employerFilterData['empty_pv_rows']) ? $employerFilterData['empty_pv_rows'] : [];
    ...
    <div class="col-md-12 p-3 border border-with-label" data-label="">
        <div class="table-responsive m-lg-n2">
            <table class="table table-bordered table-striped" id="pv_company_report">
                ...
                <tbody>
                @php
                    $totalCount = count($employerFilterData['pv_company_data']);
                    $i = 1;
                @endphp
                @foreach($employerFilterData['pv_company_data'] as $key => $pvCompanyData)
                    @php
                    ...
                    @if(isset($employerFilterData['poc_data'][$key]) && $employerFilterData['poc_data'][$key])
                        @foreach($employerFilterData['poc_data'][$key] as $pocName => $pocData)
