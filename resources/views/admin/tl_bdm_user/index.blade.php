                ...
                <div class="col-12">
                    <div class="card card-info card-outline">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="{{ route('tl_bdm_user.create') }}"><button class="btn btn-info float-right" type="button" style="margin-right: 1.5%;"><i class="fa fa-plus pr-1"></i> Add New</button></a>
                                </div>
                            </div>
                        </div>
    ...
    $(function () {
        ...
        $('#usersTable tbody').on('click', '.deleteUser', function (event) {
            ...
            function(isConfirm) {
                if (isConfirm) {
                    $.ajax({
                        url: "{{url('admin/tl_bdm_user')}}/"+roleId,
                        type: "DELETE",
