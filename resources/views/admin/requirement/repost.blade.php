            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        {!! Form::model($requirement,['url' => route('requirement.saveRepostRequirement',['id'=>$requirement->id]),'method'=>'post','id' => 'requirementsForm','class' => 'form-horizontal','files'=>true]) !!}
                        <div class="card-body">
                            @include ('admin.requirement.form')
                        </div>
                        <div class="card-footer">
                            <a href="{{ route('requirement.index') }}" ><button class="btn btn-default" type="button">Back</button></a>
                            <button class="btn btn-info float-right" type="submit">Repost</button>
                        </div>
                        {!! Form::close() !!}
                    </div>
                </div>
