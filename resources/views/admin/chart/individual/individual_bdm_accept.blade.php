<div class="card card-info card-outline">
    <div class="card-header">
        <h3 class="card-title"><i class="fa fa-chart-line"></i> Bdm Accept</h3>
        ...
        <div class="chart"><div class="chartjs-size-monitor"><div class="chartjs-size-monitor-expand"><div class=""></div></div><div class="chartjs-size-monitor-shrink"><div class=""></div></div></div>
            <div class="row">
                <div class="col-2">
                    <div class="form-group">
                        <div class="input-group">
                            <label class="control-label mr-3 mt-1 h5" style="font-weight: 400" for="individual_bdm_accept_count_fromDate">From: </label>
                ...
                <div class="col-2">
                    <div class="form-group">
                        <div class="input-group">
                            <label class="control-label mr-3 mt-1 h5" style="font-weight: 400" for="individual_bdm_accept_count_toDate">To: </label>
                            <div class="input-group-prepend">
                                <span class="input-group-text">
                                    <i class="far fa-calendar-alt"></i>
                                </span>
                ...
                <div class="col-8">
                    <div class="row">
                        <div class="col-5">
                            <div class="individual-bdm_accept-count-recruiter-type">
                                <div class="row">
                            ...
                            <div class="individual-bdm_accept-count-bdm-type">
                                <div class="row">
                                    <div class="col-3 text-right">
                        ...
                        <div class="col-4 text-right">
                            <div class="btn-group btn-group-toggle mb-2" data-toggle="buttons">
                                <label class="btn btn-sm btn-outline-danger active">
                                    <input type="radio" class="individual-bdm_accept-type" name="individual-bdm_accept-options" data-type="monthly" autocomplete="off" checked="">Monthly
                                </label>
                                <label class="btn btn-sm btn-outline-danger">
                                    <input type="radio" class="individual-bdm_accept-type" name="individual-bdm_accept-options" data-type="weekly" autocomplete="off">Weekly
                                </label>
                                <label class="btn btn-sm btn-outline-danger">
                                    <input type="radio" class="individual-bdm_accept-type" name="individual-bdm_accept-options" data-type="daily" autocomplete="off">Daily
                                </label>
                                <label class="btn btn-sm btn-outline-danger">
                                    <input type="radio" class="individual-bdm_accept-type" name="individual-bdm_accept-options" data-type="time_frame" autocomplete="off">Time Frame
                                </label>
                            </div>
                        </div>
                        <div class="col-3 text-right">
                            <div class="btn-group btn-group-toggle mb-2" data-toggle="buttons">
                                <label class="btn btn-sm btn-outline-danger">
                                    <input type="radio" class="individual-bdm_accept-day-type" name="individual-bdm_accept-day-options" data-type="30" autocomplete="off">30 Days
                                </label>
                                <label class="btn btn-sm btn-outline-danger">
                                    <input type="radio" class="individual-bdm_accept-day-type" name="individual-bdm_accept-day-options" data-type="60" autocomplete="off">60 Days
                                </label>
                                <label class="btn btn-sm btn-outline-danger">
                                    <input type="radio" class="individual-bdm_accept-day-type" name="individual-bdm_accept-day-options" data-type="90" autocomplete="off">90 Days
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-3 text-right">
                    <div class="row">
                        ...
                        <div class="col-2 text-right">
                            <label class="control-label mr-3 mt-1 h5" style="font-weight: 400" for="individual_bdm_accept_count_step_size">Step:</label>
                        </div>
                        <div class="col-5 text-right">
                            <select style="width: 100%" class="select2" id="individual_bdm_accept_count_step_size">
                        ...
                        <div class="col-2 text-right">
                            <div class="btn-group btn-group-toggle mb-2" data-toggle="buttons">
                                <label class="btn btn-sm btn-outline-danger">
                                    <input type="radio" class="individual-bdm-accept-count-next-prev-button" data-type="-1" name="individual-requirement-assign-next-prev-options" autocomplete="off"><i class="fa fa-arrow-circle-left" data-toggle="tooltip" title="Previous" data-trigger="hover"></i>
                                </label>
                                <label class="btn btn-sm btn-outline-danger">
                                    <input type="radio" class="individual-bdm-accept-count-next-prev-button" data-type="1" name="individual-requirement-assign-next-prev-options" autocomplete="off"><i class="fa fa-arrow-circle-right" data-toggle="tooltip" title="Next" data-trigger="hover"></i>
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-2 text-right">
                    <div class="btn-group btn-group-toggle mb-2" data-toggle="buttons">
                        @if(in_array(getLoggedInUserRole(), ['admin', 'bdm']))
                            <label class="btn btn-sm btn-outline-danger">
                                <input type="radio" class="individual-bdm_accept-count-user-type-bdm individual-bdm_accept-count-user-type" name="individual-bdm_accept-count-user-options" data-type="bdm" autocomplete="off">BDM
                            </label>
                        @endif
                        @if(in_array(getLoggedInUserRole(), ['admin', 'recruiter']))
                            <label class="btn btn-sm btn-outline-danger">
                                <input type="radio" class="individual-bdm_accept-count-user-type-recruiter individual-bdm_accept-count-user-type" name="individual-bdm_accept-count-user-options" data-type="recruiter" autocomplete="off">Recruiter
                        @endif
                    </div>
                </div>
            </div>
            <canvas id="individuabdm_acceptCount" style="min-height: 250px; height: 250px; max-height: 360px; max-width: 100%; display: block; width: 570px;" width="570" height="250" class="chartjs-render-monitor"></canvas>
        </div>
    </div>
</div>
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var instanceRec = $('#individual_bdm_accept_count_recruiter').comboTree({
            source : recData,
            isMultiple:true,
            selectAll:true,
            cascadeSelect:true,
        ...
        $(document).ready(function () {
            ...
            @if(in_array(getLoggedInUserRole(), ['admin','bdm']))
                $('.individual-bdm_accept-count-user-type-bdm').click();
            @else
        ...
        function prepareindividuabdmAcceptCounts() {
            var isUniqueSub = 0;
            if($('#unique_individual_bdm_accepts').is(':checked')){
                isUniqueSub = 1;
            }
            $.ajax({
                url: "{{ route('getIndividualbdmAccept') }}",
                data: {
                    '_token'    : '{{ csrf_token() }}',
                    'fromDate'  : $('#individual_bdm_accept_count_fromDate').val(),
                    'toDate'    : $('#individual_bdm_accept_count_toDate').val(),
                    'type'      : $(".individual-bdm_accept-type:checked").attr("data-type"),
                ...
                success: function (response) {
                    if (response.status == 1) {
                        ...
                        var ctx = document.getElementById('individuabdm_acceptCount').getContext('2d');
                        var chartInstance = Chart.getChart('individuabdm_acceptCount');
                        if (chartInstance) {
        ...
        $(".individual-bdm_accept-day-type").change(function (){
            var dayType = parseInt($(this).attr('data-type'));
            if(!dayType){
                return;
            }
            $('#individual_bdm_accept_count_step_size').val("0").trigger("change");
            $(".individual-bdm-accept-count-next-prev-button").prop("checked", false).parent().removeClass('active');
            var fromDate = new Date();
            var toDate = new Date();
            fromDate.setDate(fromDate.getDate() -  dayType);
            $('#individual_bdm_accept_count_fromDate').val(formatDate(fromDate));
            $('#individual_bdm_accept_count_toDate').val(formatDate(toDate));
            prepareindividuabdmAcceptCounts();
        });

        $('.individual-bdm_accept-type').on('change', function() {
            $("#individual_bdm_accept_count_step_size").trigger("change");
            prepareindividuabdmAcceptCounts();
        });

        $('.individual-bdm_accept-count-user-type').change(function (){
            var dayType = $(this).attr('data-type');
            if(dayType == 'bdm'){
                $('.individual-bdm_accept-count-bdm-type').show();
                $('.individual-bdm_accept-count-recruiter-type').hide();
            } else {
                $('.individual-bdm_accept-count-recruiter-type').show();
                $('.individual-bdm_accept-count-bdm-type').hide();
            }
            prepareindividuabdmAcceptCounts();
        });

        $('.isIndividualUniqueForbdm_accept').change(function (){
            prepareindividuabdmAcceptCounts();
        });

        $('.individual-bdm-accept-count-next-prev-button').click(function (){
            const stepValue = parseInt($('#individual_bdm_accept_count_step_size').val());
            if(!stepValue){
                swal('Error', 'Please Select Step Size', 'error');
                return;
            }
            const fromDateInput = $('#individual_bdm_accept_count_fromDate');
            const toDateInput   = $('#individual_bdm_accept_count_toDate');
        ...
        $('#individual_bdm_accept_count_step_size').change(function(){
