                ...
                <div class="col-2">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            @endphp
                            {!! Form::text('fromDate', \Carbon\Carbon::now()->subDays($defaultDays)->format('m/d/Y'), ['autocomplete' => 'off', 'class' => 'datepicker individual-interview-count-datepicker form-control float-right chart-from-datepicker char-datepick', 'placeholder' => 'Select From Date', 'id' => 'individual_interview_count_fromDate']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-2">
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            {!! Form::text('toDate', \Carbon\Carbon::now()->format('m/d/Y'), ['autocomplete' => 'off', 'class' => 'datepicker individual-interview-count-datepicker form-control float-right chart-to-datepicker char-datepick', 'placeholder' => 'Select To Date', 'id' => 'individual_interview_count_toDate']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-8">
                        ...
                        <div class="col-5">
                            <div class="individual-interview-count-recruiter-type">
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        {!! Form::text('', null, ['placeholder' => 'Please Select user', 'width' => '100%', 'id' => 'individual_interview_count_recruiter', 'class' => 'chart-rec-user']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="individual-interview-count-bdm-type">
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        {!! Form::text('', null, ['placeholder' => 'Please Select user', 'id' => 'individual_interview_count_bdm', 'class' => 'chart-bdm-user']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-5">
                    <div class="row">
                        ...
                        <div class="col-1 text-right">
                            <label class="control-label mr-3 mt-1 h5" style="font-weight: 400" for="interview_count_step_size">Step: </label>
                        </div>
                        <div class="col-3 text-right">
                        ...
                        <div class="col-3 text-right">
                            <div class="btn-group btn-group-toggle mb-2" data-toggle="buttons">
                                <label class="btn btn-sm btn-outline-danger">
                                    <input type="radio" class="individual-interview-next-prev-button" data-type="-1" name="individual-interview-next-prev-options" autocomplete="off"><i class="fa fa-arrow-circle-left" data-toggle="tooltip" title="Previous" data-trigger="hover"></i>
                                </label>
                                <label class="btn btn-sm btn-outline-danger">
                                    <input type="radio" class="individual-interview-next-prev-button" data-type="1" name="individual-interview-next-prev-options" autocomplete="off"><i class="fa fa-arrow-circle-right" data-toggle="tooltip" title="Next" data-trigger="hover"></i>
                                </label>
                            </div>
                        </div>
                        <div class="col-3 text-right">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        $(document).ready(function () {
            ...
            $("#individual_interview_count_bdm, #individual_interview_count_recruiter").on('change', function () {
                if (window.globalSelectedBdmCheck && window.globalSelectedBdmCheck.includes('individual_interview_count_bdm')) {
                    window.globalSelectedBdmCheck = window.globalSelectedBdmCheck.filter(item => item !== 'individual_interview_count_bdm');
                    instanceBdm.destroy();
                    instanceBdm = $('#individual_interview_count_bdm').comboTree({
                        source : bdmData,
                        isMultiple:true,
                        selectAll:true,
                        cascadeSelect:true,
                ...
                if (window.globalSelectedRecCheck && window.globalSelectedRecCheck.includes('individual_interview_count_recruiter')) {
                    window.globalSelectedRecCheck = window.globalSelectedRecCheck.filter(item => item !== 'individual_interview_count_recruiter');
                    instanceRec.destroy();
                    instanceRec = $('#individual_interview_count_recruiter').comboTree({
                        source : recData,
                        isMultiple:true,
                        selectAll:true,
                        cascadeSelect:true,
        ...
        $(".individual-interview-count-day-type").change(function (){
            ...
            $('#interview_count_step_size').val("0").trigger("change");
            $(".individual-interview-next-prev-button").prop("checked", false).parent().removeClass('active');
        ...
        $('.individual-interview-next-prev-button').click(function (){
            const stepValue = parseInt($('#interview_count_step_size').val());
            if(!stepValue){
