    ...
    public function getEmployeeWiseData($employerName, $employerNames, $selectedEmployerNames, $request): array
    {
        ...
        foreach ($employeeNames as $employeeName) {
            ...
            $pocData = [
                ...
                'status_accepted'                   => $this->getEmployerWiseEmployeeStatusCount($employerName, 'status',$submissionModel::STATUS_ACCEPT , $employeeName, $employeeNames, $date, $request->frame_type),
                'status_rejected'                   => $this->getEmployerWiseEmployeeStatusCount($employerName, 'status',$submissionModel::STATUS_REJECTED , $employeeName, $employeeNames, $date, $request->frame_type),
                'status_pending'                    => $this->getEmployerWiseEmployeeStatusCount($employerName, 'status',$submissionModel::STATUS_PENDING , $employeeName, $employeeNames, $date, $request->frame_type),
                'status_unviewed'                   => $this->getEmployerWiseEmployeeStatusCount($employerName, 'status',$submissionModel::STATUS_NOT_VIEWED , $employeeName, $employeeNames, $date, $request->frame_type),
                'status_vendor_no_response'         => $this->getEmployerWiseEmployeeStatusCount($employerName, 'pv_status',$submissionModel::STATUS_NO_RESPONSE_FROM_PV , $employeeName, $employeeNames, $date, $request->frame_type),
                'status_vendor_rejected_by_pv'      => $this->getEmployerWiseEmployeeStatusCount($employerName, 'pv_status',$submissionModel::STATUS_REJECTED_BY_PV , $employeeName, $employeeNames, $date, $request->frame_type),
                'status_rejected_by_client'         => $this->getEmployerWiseEmployeeStatusCount($employerName, 'pv_status',$submissionModel::STATUS_REJECTED_BY_END_CLIENT , $employeeName, $employeeNames, $date, $request->frame_type),
                'status_submitted_to_end_client'    => $this->getEmployerWiseEmployeeStatusCount($employerName, 'pv_status',$submissionModel::STATUS_SUBMITTED_TO_END_CLIENT , $employeeName, $employeeNames, $date, $request->frame_type),
                'status_position_closed'            => $this->getEmployerWiseEmployeeStatusCount($employerName, 'pv_status',$submissionModel::STATUS_POSITION_CLOSED , $employeeName, $employeeNames, $date, $request->frame_type),
                'status_scheduled'                  => $this->getEmployerWiseEmployeeClientStatusCount($employerName,$interviewModel::STATUS_SCHEDULED, $employeeName, $employeeNames, $date, $request->frame_type),
                'status_re_scheduled'               => $this->getEmployerWiseEmployeeClientStatusCount($employerName,$interviewModel::STATUS_RE_SCHEDULED, $employeeName, $employeeNames, $date, $request->frame_type),
                'status_selected_for_another_round' => $this->getEmployerWiseEmployeeClientStatusCount($employerName,$interviewModel::STATUS_SELECTED_FOR_NEXT_ROUND, $employeeName, $employeeNames, $date, $request->frame_type),
                'status_waiting_feedback'           => $this->getEmployerWiseEmployeeClientStatusCount($employerName,$interviewModel::STATUS_WAITING_FEEDBACK, $employeeName, $employeeNames, $date, $request->frame_type),
                'status_position_confirm'           => $this->getEmployerWiseEmployeeClientStatusCount($employerName,$interviewModel::STATUS_CONFIRMED_POSITION, $employeeName, $employeeNames, $date, $request->frame_type),
                'status_client_rejected'            => $this->getEmployerWiseEmployeeClientStatusCount($employerName,$interviewModel::STATUS_REJECTED, $employeeName, $employeeNames, $date, $request->frame_type),
                'status_backout'                    => $this->getEmployerWiseEmployeeClientStatusCount($employerName,$interviewModel::STATUS_BACKOUT, $employeeName, $employeeNames, $date, $request->frame_type),
                'client_status_total'               => $this->getEmployerWiseEmployeeClientStatusCount($employerName,'all', $employeeName, $employeeNames, $date, $request->frame_type),
